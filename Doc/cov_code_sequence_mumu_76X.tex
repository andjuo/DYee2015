...
only one function,\\
\indent
\myund{combineData(covEE_inp,covMM_inp,covEM_inp,outputFileTag,plotTag,flagPrintCanvases)}\\
\noindent
...
% --------------------------------------------------------------
\subsection{Calculation of the efficiency scale factor systematic covariance}
...
I notice that I have already a macro \myund{calcRhoRndVec_ee_syst.C},
so I look it up in this document and see its description in section
\ref{sect-DielectronCov}, dated from Jan 19, 2017.
