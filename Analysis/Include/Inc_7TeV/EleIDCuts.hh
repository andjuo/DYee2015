...
inline 
Bool_t passEGM2011(const mithep::TDielectron *dielectron, TEleID_t eleID, double rho) {
  if (eleID==_EleID_EGM2011_Medium)
    return passEGM2011(dielectron,WP_MEDIUM,rho);
  else {
    std::cout << "passEGM2011(dielectron,eleID,rho): wrong eleID\n";
    return false;
  }
}
